...
class TestController extends Controller
{
    public function alipay()
    {
        ...
        $version = '1.0';
        $return_url = 'http://www.wechat.com/test/alipay/return';       // 支付宝同步通知
        $notify_url = 'http://www.wechat.com/test/alipay/notify';        // 支付宝异步通知地址
        $biz_content = '';
        // 请求参数
        $out_trade_no = time() . rand(1111,9999);       //商户订单号
        $product_code = 'FAST_INSTANT_TRADE_PAY';
        $total_amount = 10;
        $subject = '这是沙箱测试订单' . $out_trade_no;
        $request_param = [
